...
def create_hub_layer(hub_list, fgroup, sub_hub_list= [], primary_icon='img/lg_air_icon.png', secondary_icon='img/secondary.png'):
    ...
    for i in range(len(airline_df)):
        ...
        icon = folium.features.CustomIcon(secondary_icon if airline_df.iloc[i]['ident'] in sub_hub_list else primary_icon, 
...
create_hub_layer(aa_list, american_hubs_fg, [], 'img/aa-primary.png', 'img/aa-secondary.png')
american_hubs_fg.add_child(folium.plugins.AntPath(get_ant_coords(aa_list), color= '#B61F23'))
...
create_hub_layer(delta_list, delta_hubs_fg, delta_list_small, 'img/delta-icon2.png', 'img/delta-tail.png')
delta_hubs_fg.add_child(folium.plugins.AntPath(get_ant_coords(delta_list), color='#003268'))
...
create_hub_layer(united_list, united_hubs_fg, [], 'img/united-prim-white.png', 'img/united-second-yellow.png')
united_hubs_fg.add_child(folium.plugins.AntPath(get_ant_coords(united_list), color='#00fff7'))
...
create_hub_layer(alaskan_list, alaskan_hubs_fg, alaskan_list_small, 'img/alaska-face.png', 'img/alaska-tail.png')
alaskan_hubs_fg.add_child(folium.plugins.AntPath(get_ant_coords(alaskan_list), color='#B3D57D', pulseColor='#00385F'))
...
create_hub_layer(hawaiian_list, hawaiian_hubs_fg, hawaiian_small_list,'img/hawaiian2.png', 'img/hawaiian2.png')
hawaiian_hubs_fg.add_child(folium.plugins.AntPath(get_ant_coords(hawaiian_list), color= '#413691'))
...
create_hub_layer(frontier_list, frontier_hubs_fg, frontier_small_list, 'img/Frontier-Airlines-Emblem.png', 'img/Frontier-Airlines.png')
frontier_hubs_fg.add_child(folium.plugins.AntPath(get_ant_coords(frontier_list), color='#248168'))
...
create_hub_layer(jetblue_list, jetblue_hubs_fg, jetblue_small_list, 'img/jb-prim.png', 'img/jetblue-tail2.png')
...
create_hub_layer(southwest_list, southwest_hubs_fg, southwest_small_list, 'img/sw-prim.png','img/PinClipart.com_southwest-clip-art_3401242.png' )
...
create_hub_layer(spirit_list, spirit_hubs_fg, spirit_small_list, 'img/spirit.png', 'img/spirit.png')
