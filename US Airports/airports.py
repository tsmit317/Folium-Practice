...
def create_hub_layer(hub_list, main_hub, fgroup, sub_hub_list= [], primary_icon='img/lg_air_icon.png', secondary_icon='img/secondary.png'):
...
frontier_hubs_fg.add_child(folium.plugins.AntPath(create_hub_layer(frontier_list, 'KDEN', frontier_hubs_fg, frontier_small_list, 'img/Frontier-Airlines-Emblem.png', 'img/Frontier-Airlines.png'), color='#248168'))
...
temp = create_hub_layer(spirit_list, 'KACY', spirit_hubs_fg, spirit_small_list, 'img/spirit.png', 'img/spirit.png')
